class EnderecoPage { 
    ...
    editarEnderecoFaturamento(nome,sobrenome,empresa,pais,endereco,numeroendereco,cidade,estado,cep,telefone,email){
        ...
        cy.get('#billing_address_2').clear().type(numeroendereco)
    ...
    editarEnderecoEntrega(nome,sobrenome,empresa,pais,endereco,numeroendereco,cidade,estado,cep,telefone,email){
        cy.get('.woocommerce-MyAccount-navigation-link--edit-address > a').click()
        ...
        cy.get('#shipping_address_2').clear().type(numeroendereco)
